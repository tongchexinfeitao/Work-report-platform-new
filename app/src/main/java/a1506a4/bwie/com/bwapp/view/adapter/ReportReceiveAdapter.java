...
public class ReportReceiveAdapter extends RecyclerView.Adapter<ReportReceiveAdapter.MyReportViewHolder> {
    private Context context;
    private List<ReportMyLogBean.ObjectBean> list;

    public ReportReceiveAdapter(Context context, List<ReportMyLogBean.ObjectBean> list) {
    ...
    public MyReportViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.report_my_child_item, null);
    ...
    public void setOnItemClickListener(ReportReceiveAdapter.onItemClickListener onItemClickListener) {
